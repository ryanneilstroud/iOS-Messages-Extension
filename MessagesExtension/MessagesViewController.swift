...
//  MessagesExtension
//
//  Created by Ryan Neil Stroud on 21/6/2017.
...
class MessagesViewController: MSMessagesAppViewController, CompactDelegate, ExpandedDelegate {
    ...
    override func didBecomeActive(with conversation: MSConversation) {
        presentViewControllerWith(presentationStyle: self.presentationStyle)
    }
    ...
    func presentViewControllerWith(presentationStyle: MSMessagesAppPresentationStyle) {
